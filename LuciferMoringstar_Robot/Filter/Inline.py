...
def get_reply_markup(query):
    buttons = [[
        InlineKeyboardButton('✨Support Group✨', url='t.me/RMChats'),
        InlineKeyboardButton('More Movies', url='t.me/ReeloadMedia')
        ],[
        InlineKeyboardButton('✨ ReeloadMedia ✨', url=f'{TUTORIAL}')
        ],[
